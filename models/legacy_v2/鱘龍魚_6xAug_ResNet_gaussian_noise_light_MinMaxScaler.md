...
## Model Information
- **Model Name**: ResNet_gaussian_noise_light_MinMaxScaler
- **Architecture**: ResNet
...
# Load model package
with open('C:/Users/LBK/Downloads/6x Aug 鱘龍魚\ResNet_gaussian_noise_light_MinMaxScaler.pkl', 'rb') as f:
